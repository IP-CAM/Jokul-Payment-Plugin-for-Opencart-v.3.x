...
class ControllerExtensionPaymentJokulVAMandiri extends Controller
{
    const CHANNEL_CODE = '_va_mandiri';
    ...
    public function install()
    {
        if ($this->user->hasPermission('modify', 'extension/extension')) {
            ...
            $this->model_extension_payment_jokul_va_mandiri->install();
        }
    }
    ...
    public function uninstall()
    {
        if ($this->user->hasPermission('modify', 'extension/extension')) {
            $this->load->model('extension/payment/jokul' . self::CHANNEL_CODE);
            $this->model_extension_payment_jokul_va_mandiri->uninstall();
        }
    }
