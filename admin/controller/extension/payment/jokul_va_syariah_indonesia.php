...
class ControllerExtensionPaymentJokulVASyariahIndonesia extends Controller
{

    const CHANNEL_CODE = '_va_syariah_indonesia';
    ...
    public function index()
    {
        ...
        $data['channel_name'] = "Bank Syariah Indonesia VA";
        //end
    ...
    public function install()
    {
        if ($this->user->hasPermission('modify', 'extension/extension')) {
            ...
            $this->model_extension_payment_jokul_va_syariah_indonesia->install();
        }
    }
    ...
    public function uninstall()
    {
        if ($this->user->hasPermission('modify', 'extension/extension')) {
            $this->load->model('extension/payment/jokul' . self::CHANNEL_CODE);
            $this->model_extension_payment_jokul_va_syariah_indonesia->uninstall();
        }
    }
